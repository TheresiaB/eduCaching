...
public class Route2_station2_InfoVideoActivity extends AppCompatActivity {
    ...
    private String TAG = Route2_station2_InfoVideoActivity.class.getSimpleName();
    private ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_route2_station2_info_video);
        ...
        new Route2_station2_InfoVideoActivity.GetContacts().execute();
    ...
    public void addListenerOnButton() {
        ...
        buttonNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                startActivity(new Intent(context, Route2_station2_TaskVideoActivity.class));
            }
        });
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(Route2_station2_InfoVideoActivity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://educaching.f4.htw-berlin.de/route2station2info.php";
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(Route2_station2_InfoVideoActivity.this, routeList, R.layout.activity_route2_station2_info_video, new String[]{"s_text", "s_ueberschrift"},
