...
public class Route2_station2_TaskVideoActivity extends AppCompatActivity {
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(Route2_station2_TaskVideoActivity.this, routeList, R.layout.activity_route2_station2_task_video, new String[]{"a_ueAufgabenbeschreibung", "a_aufgabenbeschreibung","a_ueAufgabenloesung"},
