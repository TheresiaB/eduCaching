...
public class Route1_station4_InfoPictureActivity extends AppCompatActivity{
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(Route1_station4_InfoPictureActivity.this, "Json Data is downloading", Toast.LENGTH_LONG).show();
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "http://educaching.f4.htw-berlin.de/route1station4info.php";
